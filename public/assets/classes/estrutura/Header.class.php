...
class Header
{
    ...
    <nav class='navbar navbar-expand-lg fixed-top navbar-dark bg-dark'>
        ...
        <div class='navbar-collapse offcanvas-collapse' id='navbarsExampleDefault'>
            <ul class='navbar-nav mr-auto'>
                ...
                <li class='nav-item'>
                    <a class='nav-link' href='$var[top_menu_1l]'>$var[top_menu_1] </a>
                </li>


               <li class='nav-item dropdown'>
                    <a class='nav-link dropdown-toggle' href='' id='dropdown01' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>".$var['top_menu_6']."</a>
                ...
                <li class='nav-item dropdown'>
                    <a class='nav-link dropdown-toggle' href='$var[top_menu_2l]' id='dropdown01' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>$var[top_menu_2] </a>
                    <div class='dropdown-menu' aria-labelledby='dropdown01'>
                ...
                <li class='nav-item dropdown'>
                    <a class='nav-link dropdown-toggle' href='$var[top_menu_2l]' id='dropdown01'
                    data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>$var[top_menu_4]</a>
    ...
    <div class='nav-scroller bg-white shadow-sm'>
        <nav class='nav nav-underline'>
            ...
            <a class='nav-link' href='$var[mid_menu_6l]'>$var[mid_menu_6]</a>
...
";
    ...
    public function setHeaderNoIntermediate(){
        $var = $this->var;
            ...
            <ul class='navbar-nav mr-auto'>
               ...
               <li class='nav-item dropdown'>
                    <a class='nav-link dropdown-toggle' href='' id='dropdown01' data-toggle='dropdown'
                     aria-haspopup='true' aria-expanded='false'>".$var['top_menu_6']." </a>
                        <div class='dropdown-menu' aria-labelledby='dropdown01'>
                            <a class='dropdown-item' href='".$var['top_menu_6_0l']."'> ".$var['top_menu_6_0']." </a>
                            <a class='dropdown-item' href='".$var['top_menu_6_1l']."'> ".$var['top_menu_6_1']." </a>
                            <a class='dropdown-item' href='".$var['top_menu_6_2l']."'> ".$var['top_menu_6_2']." </a>
                ...
                <li class='nav-item dropdown'>
                    <a class='nav-link dropdown-toggle' href='$var[top_menu_2l]' id='dropdown01' data-toggle='dropdown'
                     aria-haspopup='true' aria-expanded='false'>$var[top_menu_2] </a>
                    <div class='dropdown-menu' aria-labelledby='dropdown01'>
                    <a class='dropdown-item' href='$var[top_menu_2_1l]'>$var[top_menu_2_1]</a>
                        <a class='dropdown-item' href='$var[top_menu_2_2l]'>$var[top_menu_2_2]</a>
                        <a class='dropdown-item' href='$var[top_menu_2_3l]'>$var[top_menu_2_3]</a>
